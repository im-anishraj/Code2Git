...
const localAuth = {
   ...
   */
  init() {
    this.KEY = 'code2git_token';
    this.ACCESS_TOKEN_URL = 'https://github.com/login/oauth/access_token';
    this.AUTHORIZATION_URL = 'https://github.com/login/oauth/authorize';
    this.CLIENT_ID = 'Ov23liI4od5VZ6D8IUMU';
    this.CLIENT_SECRET = 'f2a1c4fc5f8c1871b1aacac05349eefea03d76ff';
...
if (window.location.host === 'github.com') {
  chrome.storage.local.get('pipe_code2git', data => {
    if (data && data.pipe_code2git) {
